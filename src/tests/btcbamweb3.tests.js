...
const Bweb3 = require('../btcbamweb3');
...
console.log(`Your Bitcoinbam RPC address is ${getBtcbamRPCAddress()}`);
console.log(`Your Default Bitcoinbam address is ${getDefaultBtcbamAddress()}`);
...
describe('Bweb3', () => {
  ...
  beforeEach(() => {
    sweb3 = new Bweb3(getBtcbamRPCAddress());
  });
  ...
  describe('fromHexAddress()', () => {
    it('returns the Bitcoinbam address', async () => {
  ...
  !_.includes(process.argv, '--cleanenv') ? describe.skip : describe('cleanEnv tests', () => {
    describe('getNewAddress()', () => {
      it('returns a new Bitcoinbam address', async () => {
