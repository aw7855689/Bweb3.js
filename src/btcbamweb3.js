...
class Bweb3 {
  /**
   * Bweb3 constructor.
   * @param {string|Bweb3Provider} provider Either URL string to create HttpProvider or a Bweb3 compatible provider.
   */
  ...
  /** ******** RAW TRANSACTIONS ********* */
  /**
   * Get the hex address of a Bitcoinbam address.
   * @param {string} address Bitcoinbam address
  ...
  /**
   * Converts a hex address to Bitcoinbam address.
   * @param {string} hexAddress Bitcoinbam address in hex format.
   * @return {Promise} Bitcoinbam address or Error.
   */
  ...
  /** ******** UTIL ********* */
  /**
   * Validates if a valid Bitcoinbam address.
   * @param {string} address Bitcoinbam address to validate.
   ...
   * @param {string} address The Bitcoinbam address for the private key.
  ...
  /**
   * Encrypts the wallet for the first time. This will shut down the Bitcoinbam server.
  ...
  /**
   * Gets the account name associated with the Bitcoinbam address.
   * @param {string} address The Bitcoinbam address for account lookup.
  ...
  /**
   * Gets the Bitcoinbam address based on the account name.
  ...
  /**
   * Gets the Bitcoinbam address with the account name.
   * @param {string} acctName The account name ("" for default).
   * @return {Promise} Bitcoinbam address array or Error.
   */
  ...
  /**
   * Gets a new Bitcoinbam address for receiving payments.
   ...
   * @return {Promise} Array of addresses with Bitcoinbam balances or Error.
   */
  ...
  /**
   * Lists unspent transaction outputs.
   * @param {string} address Address to send Bitcoinbam to.
   ...
   * @param {string} senderAddress The Bitcoinbam address that will be used to send money from.
